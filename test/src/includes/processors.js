const rootRelativeToRelativeUrls = (scope) => {
...
export default {
    pre: [removeAllComments],
    post: [rootRelativeToRelativeUrls, removeEmptyLines]
};
